...
import type { TabDefinition } from '@edp/types';

import type { IContextMenuItem } from '@edp-core/tabs-ui';

import { computed, ref, watch } from 'vue';
import { useRoute, useRouter } from 'vue-router';

import { useContentMaximize, useTabs } from '@edp/hooks';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
...
import { getTabKey, useAccessStore, useTabbarStore } from '@edp/stores';
import { filterTree } from '@edp/utils';
