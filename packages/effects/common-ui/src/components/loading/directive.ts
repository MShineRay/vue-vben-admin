...
import { EDPLoading, EDPSpinner } from '@edp-core/shadcn-ui';
import { isString } from '@edp-core/shared/utils';
...
const loadingDirective: Directive = {
  mounted(el, binding) {
    const instance = h(EDPLoading, getOptions(binding));
    render(instance, el);
...
const spinningDirective: Directive = {
  mounted(el, binding) {
    const instance = h(EDPSpinner, getOptions(binding));
    render(instance, el);
