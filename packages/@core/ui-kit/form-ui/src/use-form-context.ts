...
import type { ExtendedFormApi, FormActions, EDPFormProps } from './types';

import { computed, unref, useSlots } from 'vue';

import { createContext } from '@edp-core/shadcn-ui';
import { isString, mergeWithArrayOverride, set } from '@edp-core/shared/utils';

import { useForm } from 'vee-validate';
import { object, ZodIntersection, ZodNumber, ZodObject, ZodString } from 'zod';
import { getDefaultsForSchema } from 'zod-defaults';

type ExtendFormProps = EDPFormProps & { formApi?: ExtendedFormApi };
...
export function useFormInitial(
  props: ComputedRef<EDPFormProps> | EDPFormProps,
) {
