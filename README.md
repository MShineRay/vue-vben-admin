...
非常欢迎你的加入！[提一个 Issue](https://github.com/anncwb/vue-edp-admin/issues/new/choose) 或者提交一个 Pull Request。
...
- [Github Discussions](https://github.com/anncwb/vue-edp-admin/discussions)

## 许可证

[MIT © EDP-2020](./LICENSE)
