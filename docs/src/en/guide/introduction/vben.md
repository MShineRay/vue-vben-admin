...
::: info You are reading the documentation for [EDP Admin](https://github.com/edpjs/vue-edp-admin) version `5.0`!
...
- [EDP Admin](https://github.com/edpjs/vue-edp-admin) is still being actively updated. Contributions are welcome to help maintain and improve the project, aiming to create a better mid- to backend solution.
