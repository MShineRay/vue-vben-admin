...
import { updatePreferences } from '@edp/preferences';
...
- Do not place business translation texts inside `@edp/locales` to better manage business and general translation texts.
...
With `@edp/locales`, you can easily use translation texts:
