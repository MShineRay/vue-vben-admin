...
With the permission codes, you can use the `AccessControl` component and API provided by `@edp/access` to show and hide buttons.

#### Component Method

```vue
<script lang="ts" setup>
import { AccessControl, useAccess } from '@edp/access';
...
```vue
<script lang="ts" setup>
import { AccessControl } from '@edp/access';
</script>
